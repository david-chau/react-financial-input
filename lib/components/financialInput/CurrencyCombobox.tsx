...
/*
    A searchable currency picker, built from `searchCurrencies` and rendered
    here rather than inside FinancialInput — the component stays a bare input,
    and this is markup you can copy and change.
